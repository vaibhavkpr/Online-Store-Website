...
class Displayed_in{
    ...
    private $db;
    private $table_name = "displayed_in";
  
    // displayed_in properties
    public $SKU;	
    public $AID;	
    public $branch_id;	
    ...
    function readOne(){
        ...
        // Query: Read single displayed_in entry using SKU
    ...
    function create(){
        ...
        // Check if displayed_in exists before creating it
    ...
    function update(){ 
        ...
        // Check if displayed_in exists before updating it
        $check_query = "SELECT SKU FROM " .$this->table_name. " WHERE SKU=" .$this->SKU. "";
        $statement = $this->db->prepare($check_query);
        $statement->bindParam(1, $this->SKU);
        $statement->execute();
    ...
    function delete(){
        ...
        // Check if displayed_in exists before deleting it
        $check_query = "SELECT SKU FROM " .$this->table_name. " WHERE SKU=" .$this->SKU. "";
        $statement = $this->db->prepare($check_query);
        $statement->bindParam(1, $this->SKU);
        $statement->execute();
        ...
        if(!$row){
            ...
            // Bind SKU of the displayed_in to be deleted
            $statement->bindParam(1, $this->SKU);
